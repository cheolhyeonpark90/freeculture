document.addEventListener('DOMContentLoaded', async () => {
    ...
    function openDropdown(type, button) {
        ...
        switch (type) {
            ...
            case 'category': content = createOptionList(categoryData); break;
        }
